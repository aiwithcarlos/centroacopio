    ...
    <div className="space-y-3">
      ...
      {preview ? (
        ...
        <button
          ...
          className="w-full max-w-sm flex flex-col items-center justify-center gap-2 p-8 border-2 border-dashed border-gray-300 rounded-xl hover:border-primary/50 hover:bg-primary-light/30 transition-colors cursor-pointer"
        >
          <svg className="w-10 h-10 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
          <span className="text-sm font-medium text-text">Agregar foto</span>
          <span className="text-xs text-text-muted">Galería, cámara o archivos</span>
        </button>
      )}
