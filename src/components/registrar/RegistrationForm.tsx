  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(err.error || 'Error al registrar el centro de acopio');
      }
      ...
      setError(
        err instanceof Error ? err.message : 'Error al registrar el centro de acopio'
      );
    } finally {
      setSubmitting(false);
    }
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
        ...
        <p className="text-green-700 text-sm mb-4">
          Tu centro de acopio ha sido registrado. Serás redirigido al mapa en unos segundos...
        </p>
        <button
          onClick={() => router.push('/')}
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <section className="bg-white border border-gray-200 rounded-xl p-5">
        <TagsSelector selected={selectedTags} onChange={setSelectedTags} />
      </section>
